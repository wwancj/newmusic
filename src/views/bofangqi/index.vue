<template>
  ...
  <div id="bofangq">
      ...
      <div class="player" ref="player">
        <div class="player__top">
          <div class="player-cover">
            <!-- <transition-group :name="transitionName">
                <div class="player-cover__item"  :style="{ backgroundImage: `url(${track.cover})` }"  v-for="track in tracks" :key="track.urlid"></div>
            </transition-group> -->

            <div class="player-cover__item"  :style="{ backgroundImage: `url(${currentTrack.cover})` }"  ></div>
          </div>
        ...
        <div class="progressw" ref="progress">
...
export default {
 ...
 data() {
      ...
      tracks: [
        {
          name: "Mekanın Sahibi",
          artist: "Norm Ender",
          cover: "http://p4.music.126.net/8C0lwLE88j9ZwLyPQ9a4FA==/109951165595770076.jpg",
          source: "http://m701.music.126.net/20211204015823/742b26ca6995b55bd34da5eee811cdd9/jdymusic/obj/wo3DlMOGwrbDjj7DisKw/5546002317/cbd0/f241/45e4/78121feb186d393eaa8014ef10d48b49.mp3",
  ...
  created() {
    if(this.$store.state.musics.length==0){
     this.tracks=[ {
          name: "冬天的秘密",
          artist: "张家旺",
          cover: "http://p4.music.126.net/MwMmrdb8zKQMdpb9mIDpXA==/109951166171043737.jpg",
          source: "http://m801.music.126.net/20211215120738/cedc8100aaaa3b07c1ba60a0b9b85a81/jdymusic/obj/wo3DlMOGwrbDjj7DisKw/6994337466/8586/b66b/91a4/0b156cc8634840cb1bb8571beee9e4f0.mp3",
          url: "",
          favorited: false
        }]
